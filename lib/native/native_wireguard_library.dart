...
@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Uint8>, ffi.Pointer<ffi.Char>)>(
    symbol: 'key_to_string')
external void key_to_string(
  ffi.Pointer<ffi.Uint8> key,
  ffi.Pointer<ffi.Char> result,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Uint8>)>(
    symbol: 'key_from_string')
external void key_from_string(
...
/// @param ip_address
@ffi.Native<
    ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.UnsignedChar>,
        ffi.Pointer<ffi.Char>, ffi.Uint16)>(symbol: 'add_server_peer')
external void add_server_peer(
  ffi.Pointer<ffi.Char> device_name,
  ffi.Pointer<ffi.UnsignedChar> public_key,
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.UnsignedChar>,
        ffi.Pointer<ffi.Char>)>(symbol: 'add_client_peer')
external void add_client_peer(
  ffi.Pointer<ffi.Char> device_name,
  ffi.Pointer<ffi.UnsignedChar> public_key,
  ffi.Pointer<ffi.Char> ip_address,
);
